const LibraryTrack = ({ setCurrentTrack, track, tracks, audioRef, isPlaying, setTracks }) => {
	// event handlers
	...
	return (
		<div onClick={songSelectHandler} className={`library-track${track.active ? ' selected' : ''}`}>
